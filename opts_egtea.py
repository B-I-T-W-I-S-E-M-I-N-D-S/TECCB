...
def parse_opt():
    ...
    parser.add_argument('--video_feature_all_train', type=str, default="./data/Egtea_features/")
    parser.add_argument('--video_feature_all_test', type=str, default="./data/Egtea_features/")
    parser.add_argument('--setup', type=str, default="")
    parser.add_argument('--exp', type=str, default="egtea")
    ...
    parser.add_argument('--video_len_file', type=str, default="./output/egtea_video_len_{}.json")
    parser.add_argument('--proposal_label_file', type=str, default="./output/egtea_proposal_label_{}.h5")
    parser.add_argument('--suppress_label_file', type=str, default="./output/egtea_suppress_label_{}.h5")
    parser.add_argument('--suppress_result_file', type=str, default="./output/egtea_suppress_result{}.h5")
    parser.add_argument('--frame_result_file', type=str, default="./output/egtea_frame_result{}.h5")
    parser.add_argument('--result_file', type=str, default="./output/egtea_result_proposal.json")
