...
def parse_opt():
    ...
    parser.add_argument('--video_len_file', type=str, default="./output/__video_len_{}.json")
    parser.add_argument('--proposal_label_file', type=str, default="./output/__proposal_label_{}.h5")
    parser.add_argument('--suppress_label_file', type=str, default="./output/__suppress_label_{}.h5")
    parser.add_argument('--suppress_result_file', type=str, default="./output/__suppress_result{}.h5")
    parser.add_argument('--frame_result_file', type=str, default="./output/frame_result{}.h5")
    parser.add_argument('--result_file', type=str, default="./output/__result_proposal{}.json")
