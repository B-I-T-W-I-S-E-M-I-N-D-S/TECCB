...
def parse_opt():
    ...
    parser.add_argument('--exp', type=str, default="cricket")
    ...
    parser.add_argument('--video_len_file', type=str, default="./output/cricket_video_len_{}.json")
    parser.add_argument('--proposal_label_file', type=str, default="./output/cricket_proposal_label_{}.h5")
    parser.add_argument('--suppress_label_file', type=str, default="./output/cricket_suppress_label_{}.h5")
    parser.add_argument('--suppress_result_file', type=str, default="./output/cricket_suppress_result{}.h5")
    parser.add_argument('--frame_result_file', type=str, default="./output/cricket_frame_result{}.h5")
    parser.add_argument('--result_file', type=str, default="./output/cricket_result_proposal.json")
