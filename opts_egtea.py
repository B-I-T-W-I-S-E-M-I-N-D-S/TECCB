...
def parse_opt():
    ...
    parser.add_argument('--video_len_file', type=str, default="./output/_video_len_{}.json")
    parser.add_argument('--proposal_label_file', type=str, default="./output/_proposal_label_{}.h5")
    parser.add_argument('--suppress_label_file', type=str, default="./output/_suppress_label_{}.h5")
    parser.add_argument('--suppress_result_file', type=str, default="./output/_suppress_result{}.h5")
    parser.add_argument('--frame_result_file', type=str, default="./output/_frame_result{}.h5")
    parser.add_argument('--result_file', type=str, default="./output/_result_proposal{}.json")
